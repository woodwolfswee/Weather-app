...
function App() {
  ...
  const url=`https://api.openweathermap.org/data/2.5/weather?q=${location}&units=metric&appid=b24804f1ec2cdaa56c1e6aa2acd80132`;
        ...
        {data.name===undefined &&
             <div>
                 <center><h2>Welcome to World's weather!</h2></center>
                  <center><p>Created by Shreyan Dhar</p></center>
                  <br/><br/><br/>
                  <center><h1>Enter your city to check the weather.</h1></center>
             </div>
             }
